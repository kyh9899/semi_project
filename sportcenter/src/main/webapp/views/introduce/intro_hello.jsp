...
<html>
<head>
<title>Intro_hello</title>
</head>
<body>
 <table>
	<div>
 <div class="intro_wrap" style="width: 700px; padding: 10px; margin: 10px">
        <td><div style="margin-bottom: 20px;"> <!-- Add margin to create space between image and text -->
         <img src="https://www.ksponco.or.kr/sports/img/olparkswim/intro.jpg" alt="올림픽수영장 직원일동" class="sign"/></td>
        <div class="cont">
            <th><div class="txt_box" style="width: 600px; border: 1px;">
